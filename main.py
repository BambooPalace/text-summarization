...
parser.add_argument("--num_epoch", type=int, default = 10, help = "Set the number of epoch")
...
parser.add_argument("--train_input",type = str, default = 'pubmed/inputs/train', help = "The filepath of input of training data")
parser.add_argument("--train_label",type = str, default = 'pubmed/labels/train', help = "The filepath of label of training data")
parser.add_argument("--train_file_list",type = str, default = None, help = "The file storing the ids of a subset of training data")
parser.add_argument("--val_input",type = str, default = 'pubmed/inputs/val', help = "The filepath of input of validation data")
parser.add_argument("--val_label",type = str, default = 'pubmed/labels/val', help = "The filepath of label of validation data")
...
parser.add_argument("--refpath", type=str, default = './pubmed/human-abstracts', help = "Directory storing human abstracts")
...
parser.add_argument("--seed", type=int, default=0, help= "Set the seed of pytorch, so that you can regenerate the result.")
